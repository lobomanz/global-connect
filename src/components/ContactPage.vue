...
const sendEmail = () => {
  if (typeof window !== 'undefined') {
    const mailtoLink = `mailto:d.arhitektura@globalconnect-doo.com?subject=Contact from ${formData.value.name}&body=Email: ${formData.value.email}%0APhone: ${formData.value.phone}%0AMessage: ${formData.value.message}`;
